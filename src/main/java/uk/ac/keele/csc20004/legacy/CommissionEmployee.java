 ...
 * employee who works on commission. The weekly earnings depend
 * on how much they sell, and on the comission rate.
 */
public class CommissionEmployee extends Employee {
   ...
   /**
    * The constructor for a CommissionEmployee.
    * Sets the attributes inherited from standard Employee, plus
    * additional attribute related to the comminssion (the weekly gross sales and
    * the
    * commission rate.
    * 
